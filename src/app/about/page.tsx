  ...
  return (
    <div className="flex flex-wrap justify-center">
      <div className="flex flex-col gap-1 px-12 md:px-96">
        ...
        <p className="mb-6" data-testid="main">WikiAnagrams is a simple website where you can search for anagrams of a word, taken from its <Link href="https://en.wiktionary.org/wiki/Wiktionary:Main_Page" className="underline decoration-san-marino-500 dark:decoration-san-marino-200">Wiktionary</Link> page.</p>
